...
import com.armatov.music.appwidgets.AppWidgetBig;
import com.armatov.music.appwidgets.AppWidgetCard;
import com.armatov.music.appwidgets.AppWidgetCardDark;
import com.armatov.music.appwidgets.AppWidgetClassic;
import com.armatov.music.appwidgets.AppWidgetClassicDark;
import com.armatov.music.appwidgets.AppWidgetSmall;
import com.armatov.music.appwidgets.AppWidgetSmallDark;
import com.armatov.music.glide.BlurTransformation;
import com.armatov.music.glide.SongGlideRequest;
import com.armatov.music.helper.ShuffleHelper;
import com.armatov.music.helper.StopWatch;
import com.armatov.music.loader.PlaylistSongLoader;
import com.armatov.music.model.AbsCustomPlaylist;
import com.armatov.music.model.Playlist;
import com.armatov.music.model.Song;
import com.armatov.music.provider.HistoryStore;
import com.armatov.music.provider.MusicPlaybackQueueStore;
import com.armatov.music.provider.SongPlayCountStore;
import com.armatov.music.service.notification.PlayingNotification;
import com.armatov.music.service.notification.PlayingNotificationImpl;
import com.armatov.music.service.notification.PlayingNotificationImpl24;
...
public class MusicService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener, Playback.PlaybackCallbacks {
    ...
    public static final String MUSIC_PACKAGE_NAME = "com.armatov.music";
    ...
    public void open(long[] list, int startPositoin, boolean startPlaying) {
        List<Song> songs = new ArrayList<>();
        int len = playingQueue.size();
        for(int i = 0; i < len; i++){
            if(playingQueue.get(i).id == (int) list[i]){
                songs.add(playingQueue.get(i));

            }
        }
        openQueue(songs, startPositoin, startPlaying);
    }
