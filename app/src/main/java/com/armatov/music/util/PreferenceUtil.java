...
import com.armatov.music.helper.SortOrder;
import com.armatov.music.model.CategoryInfo;
import com.armatov.music.ui.fragments.mainactivity.folders.FoldersFragment;
...
public final class PreferenceUtil {
    ...
    public static final String CHECK_ITEM = "checkeditem";
    ...
    public final boolean getKeepScreenOnOff() {

        return mPreferences.getBoolean(NOW_PLAYING_SCREEN_ID, true);
    }

    @SuppressLint("CommitPrefEdits")
    public void setKeepScreenOnOff(boolean b) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putBoolean(NOW_PLAYING_SCREEN_ID, b);
        editor.commit();
    }
    ...
    public void setCheckedItem(int b) {
        SharedPreferences.Editor editor = mPreferences.edit();
        editor.putInt("checkeditem", b);
        editor.apply();
    }
    public int getCheckedItem() {
        return mPreferences.getInt("checkeditem", 0);
    }

    public void setTimeOfWatchVideo(long time, int pos) {
        SharedPreferences.Editor editor = mPreferences.edit();
        editor.putLong("video" + pos, time);
        editor.apply();
    }
    public long getTimeOfWatchVideo(int pos) {
        return mPreferences.getLong("video" + pos, 0);
    }


    public String getState(){
        return mPreferences.getString("state", "0");
    }

    public void setState(String state){
        mPreferences.edit().putString("state", state).apply();
    }



    public String getState1(){
        return mPreferences.getString("state1", "0");
    }

    public void setState1(String state){
        mPreferences.edit().putString("state1", state).apply();
    }
    ...
    public String getState2(){
        return mPreferences.getString("state2", "0");
    }

    public void setState2(String state){
        mPreferences.edit().putString("state2", state).apply();
    }

//////////////////////////////////////////

    public String getState3(){
        return mPreferences.getString("state3", "0");
    }

    public void setState3(String state){
        mPreferences.edit().putString("state3", state).apply();
    }

    //////////////////////////////////////////
    public String getState4(){
        return mPreferences.getString("state4", "0");
    }

    public void setState4(String state){
        mPreferences.edit().putString("state4", state).apply();
    }
    /////////////////////////////////////////////
    public String getState5(){
        return mPreferences.getString("state5", "0");
    }

    public void setState5(String state){
        mPreferences.edit().putString("state5", state).apply();
    }

    public String getState6(){
        return mPreferences.getString("state6", "0");
    }

    public void setState6(String state){
        mPreferences.edit().putString("state6", state).apply();
    }

    public String getState7(){
        return mPreferences.getString("state7", "0");
    }

    public void setState7(String state){
        mPreferences.edit().putString("state7", state).apply();
    }

    public String getState8(){
        return mPreferences.getString("state8", "0");
    }

    public void setState8(String state){
        mPreferences.edit().putString("state8", state).apply();
    }

    public String getState9(){
        return mPreferences.getString("state9", "0");
    }

    public void setState9(String state){
        mPreferences.edit().putString("state9", state).apply();
    }



    ///////////////////////////////////////////////////////////////////////////////////
    public void setSelectedItemOfSpinerEqualizer(int state){
        mPreferences.edit().putInt("pos", state).apply();
    }
    public int getSelectedItemOfSpinerEqualizer(){
        return mPreferences.getInt("pos",1);
    }
    ////////////////////////////////////////////////////////////////////////////
    public void setCustomSeekBarState1(int customSeekBarState) {
        mPreferences.edit().putInt("CustomSeekBarState1",customSeekBarState).apply();
    }
    public int getCustomSeekBarState1(){
        return mPreferences.getInt("CustomSeekBarState1",15);
    }
    public void setCustomSeekBarState2(int customSeekBarState) {
        mPreferences.edit().putInt("CustomSeekBarState2",customSeekBarState).apply();
    }
    public int getCustomSeekBarState2(){
        return mPreferences.getInt("CustomSeekBarState2",15);
    }
    public void setCustomSeekBarState3(int customSeekBarState) {
        mPreferences.edit().putInt("CustomSeekBarState3",customSeekBarState).apply();
    }
    public int getCustomSeekBarState3(){
        return mPreferences.getInt("CustomSeekBarState3",15);
    }
    public void setCustomSeekBarState4(int customSeekBarState) {
        mPreferences.edit().putInt("CustomSeekBarState4",customSeekBarState).apply();
    }
    public int getCustomSeekBarState4(){
        return mPreferences.getInt("CustomSeekBarState4",15);
    }
    /////////////////////////////////////////
    public void setCustomSeekBarState5(int customSeekBarState) {
        mPreferences.edit().putInt("CustomSeekBarState5",customSeekBarState).apply();
    }
    public int getCustomSeekBarState5(){
        return mPreferences.getInt("CustomSeekBarState5",15);
    }
    //////////////////////////
    public void setCustomSeekBarState6(int customSeekBarState) {
        mPreferences.edit().putInt("CustomSeekBarState6",customSeekBarState).apply();
    }
    public int getCustomSeekBarState6(){
        return mPreferences.getInt("CustomSeekBarState6",15);
    }
    //////////////////////////
    public void setCustomSeekBarState7(int customSeekBarState) {
        mPreferences.edit().putInt("CustomSeekBarState7",customSeekBarState).apply();
    }
    public int getCustomSeekBarState7(){
        return mPreferences.getInt("CustomSeekBarState7",15);
    }
    ////////////////////////////////////////////
    public void setCustomSeekBarState8(int customSeekBarState) {
        mPreferences.edit().putInt("CustomSeekBarState8",customSeekBarState).apply();
    }
    public int getCustomSeekBarState8(){
        return mPreferences.getInt("CustomSeekBarState8",15);
    }

    ///////////////////////////////////////////

    public void setCustomSeekBarState9(int customSeekBarState) {
        mPreferences.edit().putInt("CustomSeekBarState9",customSeekBarState).apply();
    }
    public int getCustomSeekBarState9(){
        return mPreferences.getInt("CustomSeekBarState9",15);
    }
    /////////////////////////////////////////

    public void setCustomSeekBarState10(int customSeekBarState) {
        mPreferences.edit().putInt("CustomSeekBarState10",customSeekBarState).apply();
    }
    public int getCustomSeekBarState10(){
        return mPreferences.getInt("CustomSeekBarState10",15);
    }
    ...
    public int getBassBoostStrength() {
        return mPreferences.getInt("bassBoost", 0);
    }
    public void setBassBoostStrength(int bassBoost){
        mPreferences.edit().putInt("bassBoost",bassBoost).apply();
    }


    public int getVirtualizerStrength() {
        return mPreferences.getInt("VirtualizerStrength", 0);
    }
    public void setVirtualizerStrength(int VirtualizerStrength){
        mPreferences.edit().putInt("VirtualizerStrength",VirtualizerStrength).apply();
    }
