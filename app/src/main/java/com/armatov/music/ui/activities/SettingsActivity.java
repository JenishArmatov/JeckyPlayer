...
import com.armatov.music.misc.NonProAllowedColors;
import com.armatov.music.preferences.BlacklistPreference;
import com.armatov.music.preferences.BlacklistPreferenceDialog;
import com.armatov.music.preferences.LibraryPreference;
import com.armatov.music.preferences.LibraryPreferenceDialog;
...
public class SettingsActivity extends AbsBaseActivity implements ColorChooserDialog.ColorCallback {
    ...
    public static class SettingsFragment extends ATEPreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        private void invalidateSettings() {
            ...
            final TwoStatePreference keepScreen = (TwoStatePreference) findPreference("now_playing_screen_id");
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N_MR1) {
                keepScreen.setVisible(false);
            } else {
                keepScreen.setChecked(PreferenceUtil.getInstance(getActivity()).getKeepScreenOnOff());
                keepScreen.setOnPreferenceChangeListener((preference, newValue) -> {
                    // Save preference
                    PreferenceUtil.getInstance(getActivity()).setKeepScreenOnOff((Boolean) newValue);
                    recreate = true;
