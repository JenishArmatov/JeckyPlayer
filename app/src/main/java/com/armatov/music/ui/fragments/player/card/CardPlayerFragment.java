package com.armatov.music.ui.fragments.player.card;
...
import com.armatov.music.DoubleClick;
import com.armatov.music.R;
import com.armatov.music.adapter.base.MediaEntryViewHolder;
import com.armatov.music.adapter.song.PlayingQueueAdapter;
import com.armatov.music.dialogs.LyricsDialog;
import com.armatov.music.dialogs.SongShareDialog;
import com.armatov.music.helper.MusicPlayerRemote;
import com.armatov.music.helper.menu.SongMenuHelper;
import com.armatov.music.interfaces.DoubleClickListener;
import com.armatov.music.model.Song;
import com.armatov.music.model.lyrics.Lyrics;

import com.armatov.music.ui.activities.base.AbsSlidingMusicPanelActivity;
import com.armatov.music.ui.fragments.player.AbsPlayerFragment;
import com.armatov.music.ui.fragments.player.PlayerAlbumCoverFragment;
import com.armatov.music.util.ImageUtil;
import com.armatov.music.util.MusicUtil;
import com.armatov.music.util.Util;
import com.armatov.music.util.ViewUtil;
import com.armatov.music.views.WidthFitSquareLayout;
...
public class CardPlayerFragment extends AbsPlayerFragment implements PlayerAlbumCoverFragment.Callbacks, SlidingUpPanelLayout.PanelSlideListener{
    ...
    @BindView(R.id.full_screen_visualizer)
    ...
    @BindView(R.id.full_screen_drawer_layout)
    ...
    private void setUpSubFragments() {
        ...
        v = playerAlbumCoverFragment.getVisualiserView();
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_show_lyrics:
                ...
                return true;
            case R.id.action_fullscreen_visualization:

                setFullScreen();
                return true;
            case R.id.action_remove_visualization:
    ...
    private void setFullScreen(){
        Log.d("///Visualizer", "setFullScreen");
        ...
        visualiserView.setVisibility(View.VISIBLE);
        Classic.stars = null;
        isFullScreen = true;
        visualiserView.setOnClickListener( new DoubleClick(new DoubleClickListener() {
            @Override
    ...
    private void updateIsFavorite() {
        ...
        updateIsFavoriteTask = new AsyncTask<Song, Void, Boolean>() {
            ...
            protected Boolean doInBackground(Song... params) {
                ...
                if (activity != null) {
                    return MusicUtil.isFavorite(App.getInstance().getApplicationContext(), params[0]);
                } else {
                    cancel(false);
                    return null;
                }
    ...
    protected void toggleFavorite(Song song) {
        ...
        if (song.id == MusicPlayerRemote.getCurrentSong().id) {
            if (MusicUtil.isFavorite(getContext(), song)) {
    ...
    public boolean onBackPressed() {
        ...
        if (slidingUpPanelLayout != null) {
            if(isFullScreen){
                ...
                visualiserView.setVisibility(View.GONE);
                if(v != null){
                    v.setVisibility(View.VISIBLE);
                }
    ...
    private static abstract class BaseImpl implements Impl {
        ...
        public AnimatorSet createDefaultColorChangeAnimatorSet(int newColor) {
            ...
            newColor = ThemeStore.primaryColor(fragment.getContext());
