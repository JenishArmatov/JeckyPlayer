package com.armatov.music.ui.fragments.player.flat;
...
public class FlatPlayerFragment extends AbsPlayerFragment implements PlayerAlbumCoverFragment.Callbacks, SlidingUpPanelLayout.PanelSlideListener {
    ...
    private void setUpSubFragments() {
        ...
        if (playerAlbumCoverFragment != null) {
            ...
            playerAlbumCoverFragment.getVisualiserView().setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    public boolean onBackPressed() {
        ...
        if (slidingUpPanelLayout != null) {
            ...
            if(isFullScreen){
                ...
                playerAlbumCoverFragment.getVisualiserView().setVisibility(View.VISIBLE);
                visualiserView.setVisibility(View.GONE);

                Log.d("//on backpress","isFullscreen");
                isFullScreen = false;
                return true;
            }
