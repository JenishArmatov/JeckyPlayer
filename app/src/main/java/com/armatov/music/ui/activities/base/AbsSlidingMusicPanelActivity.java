package com.armatov.music.ui.activities.base;
...
import com.armatov.music.ui.fragments.player.MiniPlayerFragment;
import com.armatov.music.ui.fragments.player.card.CardPlayerFragment;
...
public abstract class AbsSlidingMusicPanelActivity extends AbsMusicServiceActivity implements SlidingUpPanelLayout.PanelSlideListener, CardPlayerFragment.Callbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        keepScreenOn = PreferenceUtil.getInstance(this).getKeepScreenOnOff();
    ...
    public void setSlidingPanelTouchEnabled(boolean b) {
        slidingUpPanelLayout.setTouchEnabled(b);
    }
