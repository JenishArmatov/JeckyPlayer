...
import com.armatov.music.ui.activities.tageditor.SongTagEditorActivity;
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_fullscreen_visualization:
                ...
                return true;
            case R.id.action_change_visualizer:
            //    Player.checkedItem++;
            //    if(Player.checkedItem > 14){
            //        Player.checkedItem = 0;
            //    }
                NavigationUtil.changeVisualizer(getActivity());
                return true;
